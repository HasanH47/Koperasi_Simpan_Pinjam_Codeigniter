...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                    ...
                    <section class="col-lg-7 connectedSortable">
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body chat" id="chat-box">
                                <!-- chat item -->
                                <div class="item">
                                    <img src="<?php base_url() ?> assetAdmin/dist/img/user4-128x128.jpg"
                                ...
                                <!-- chat item -->
                                <div class="item">
                                    <img src="<?php base_url() ?> assetAdmin/dist/img/user3-128x128.jpg"
                                ...
                                <!-- chat item -->
                                <div class="item">
                                    <img src="<?php base_url() ?> assetAdmin/dist/img/user2-160x160.jpg"
                                        alt="user image" class="offline">
        ...
        <?php $this->load->view("admin/_includes/control_sidebar") ?>
        <?php $this->load->view("admin/_includes/bottom_script") ?>
