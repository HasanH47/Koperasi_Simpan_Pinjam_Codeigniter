...
<head>
    ...
    <title>Koperasi Skedmart | Log in</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo base_url('Auth') ?>"><b>Koperasi</b>Skedmart</a>
        </div>
        ...
        <div class="login-box-body">
            ...
            <form action="<?php echo base_url('Auth/add') ?>" method="post">
                ...
                <div class="form-group has-feedback">
                    <input name="nama" class="form-control <?php echo form_error('nama') ? 'is-invalid' : '' ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" class="<?php echo form_error('jenis_kelamin') ? 'is-invalid' : '' ?>"
                ...
                <div class="form-group has-feedback">
                    <input name="nohp" class="form-control <?php echo form_error('nohp') ? 'is-invalid' : '' ?>"
                        placeholder="Masukan Nomor HP / Telphone" type="text">
                    <div class="invalid-feedback">
